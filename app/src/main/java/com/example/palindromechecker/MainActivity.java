        ...
        buttonSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Log.i("Palindrome", "The Palindrome button was clicked");
                    if (!s.isEmpty()) {
                    isPalindrome = s.equals(new StringBuilder(s).reverse().toString()).toLowerCase;
                    if (isPalindrome == true) {

                        textResult.setText("This is a palindrome");

                    } else {
                        textResult.setText("This is not a palindrome");
